...
APP_ID = int(os.environ.get("APP_ID", "29453152"))
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002147067132"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "1052054451").split()):
        ADMINS.append(int(x))
except ValueError:
